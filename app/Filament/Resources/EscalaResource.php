...
class EscalaResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\TextInput::make('culto_id')
                    ->required()
                    ->numeric(),
                Forms\Components\TextInput::make('ministerio_id')
                    ->required()
                    ->numeric(),
            ]);
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('culto_id')
                    ->numeric()
                    ->sortable(),
                Tables\Columns\TextColumn::make('ministerio_id')
                    ->numeric()
                    ->sortable(),
